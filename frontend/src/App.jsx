								...
								<Nav className="me-auto w-100 justify-content-end ">
									<Link to="/cart" className="nav-link">
										<i
											...
											id="icon"></i>
										<span className="px-1 fw-bold text-white">Cart</span>
										{cart.cartItems.length > 0 && (
											<Badge pill className="cart_num">
									...
									{userInfo ? (
										<NavDropdown
											...
											<LinkContainer to="/profile">
												<NavDropdown.Item className="fw-bold text-white">
													User Profile
												</NavDropdown.Item>
											</LinkContainer>
				...
				<div
					...
					<Nav className="flex-column text-white w-100 p-2">
						...
						{categories.map((category) => (
							<Nav.Item key={category} className="m-1">
								<LinkContainer
									to={{ pathname: "/search", search: `category=${category}` }}
									onClick={() => setSidebarIsOpen(false)}>
									<Nav.Link className="cat">{category}</Nav.Link>
								</LinkContainer>
							</Nav.Item>
						))}
					</Nav>
